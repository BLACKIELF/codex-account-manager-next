    ...
    async fn dashboard_snapshot_preserves_skill_usages_from_transcripts() {
        ...
        write_session_file(
            ...
            vec![
                ...
                r#"{"timestamp":"2026-07-28T12:00:00.000Z","type":"response_item","payload":{"type":"function_call","arguments":{"cmd":"Get-Content -Raw 'C:\\Users\\ExampleUser\\.codex\\skills\\blueprint\\SKILL.md'"}}}"#,
