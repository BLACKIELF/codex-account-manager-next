...
struct AgentUsageAggregator {
    ...
    private func aggregateLocalUsage(_ locals: [LocalUsage]) -> LocalUsage? {
        ...
        return LocalUsage(
            ...
            allAgentsLifetimeTokens: allAgentsSource?.allAgentsLifetimeTokens,
            allAgentsTodayTokens: allAgentsSource?.allAgentsTodayTokens,
            allAgentsShares: allAgentsSource?.allAgentsShares
        )
    }
