...
enum StatisticsTimeZonePreferenceStore {
    private static let selectionKey = "CodexManagerNext.statisticsTimeZone.selection"
...
enum StatisticsTimeZoneSelfTest {
    static func run() -> Bool {
        ...
        let suite = "CodexManagerNext.statistics-time-zone.\(UUID().uuidString)"
        ...
        defaults.set("fixed", forKey: "CodexManagerNext.statisticsTimeZone.selection")
        defaults.set("Invalid/Zone", forKey: "CodexManagerNext.statisticsTimeZone.fixedIdentifier")
