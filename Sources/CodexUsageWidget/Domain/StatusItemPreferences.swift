...
enum StatusItemPreferencesStore {
    static let displayModeKey = "CodexManagerNext.statusItem.displayMode"
    static let quotaModeKey = "CodexManagerNext.statusItem.quotaMode"
    static let visibleMetricsKey = "CodexManagerNext.statusItem.visibleMetrics"
    static let metricsSchemaVersionKey = "CodexManagerNext.statusItem.metricsSchemaVersion"
    static let showsResetCountdownKey = "CodexManagerNext.statusItem.showsResetCountdown"
